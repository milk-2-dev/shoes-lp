...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* WEBPACK VAR INJECTION */(function(global) {/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ \"./node_modules/jquery/dist/jquery.js\");\n/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var slick_carousel__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! slick-carousel */ \"./node_modules/slick-carousel/slick/slick.js\");\n/* harmony import */ var slick_carousel__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(slick_carousel__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var _fancyapps_fancybox__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @fancyapps/fancybox */ \"./node_modules/@fancyapps/fancybox/dist/jquery.fancybox.js\");\n/* harmony import */ var _fancyapps_fancybox__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_fancyapps_fancybox__WEBPACK_IMPORTED_MODULE_2__);\n/* harmony import */ var inputmask__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! inputmask */ \"./node_modules/inputmask/index.js\");\n/* harmony import */ var inputmask__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(inputmask__WEBPACK_IMPORTED_MODULE_3__);\n\nglobal.jQuery = jquery__WEBPACK_IMPORTED_MODULE_0___default.a;\nglobal.$ = jquery__WEBPACK_IMPORTED_MODULE_0___default.a;\n\n\n // import Shuffle from 'shufflejs';\n\nfunction countDown() {\n  var second = 1000,\n      minute = second * 60,\n      hour = minute * 60,\n      day = hour * 24;\n  var birthday = new Date().setHours(new Date().getHours() + 5),\n      countDown = new Date(birthday).getTime(),\n      x = setInterval(function () {\n    var now = new Date().getTime(),\n        distance = countDown - now; // document.getElementById(\"days\").innerText = Math.floor(distance / (day)),\n\n    document.getElementById(\"hours\").innerText = Math.floor(distance % day / hour), document.getElementById(\"minutes\").innerText = Math.floor(distance % hour / minute), document.getElementById(\"seconds\").innerText = Math.floor(distance % minute / second); //do something later when date is reached\n\n    if (distance < 0) {\n      clearInterval(x);\n    } //seconds\n\n  }, 1000);\n}\n\nvar initScrollToLink = function initScrollToLink() {\n  jquery__WEBPACK_IMPORTED_MODULE_0___default()(\".anchor\").on(\"click\", function (event) {\n    event.preventDefault();\n    var name = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).attr('href'),\n        top = jquery__WEBPACK_IMPORTED_MODULE_0___default()(name).offset().top;\n    top = +top;\n    jquery__WEBPACK_IMPORTED_MODULE_0___default()('body,html').animate({\n      scrollTop: top\n    }, 1500);\n  });\n};\n\nvar calcOldPrice = function calcOldPrice() {\n  var allElements = jquery__WEBPACK_IMPORTED_MODULE_0___default()(\".price_item.new\").get();\n  allElements.forEach(function (item) {\n    var itemPrice = jquery__WEBPACK_IMPORTED_MODULE_0___default()(item).text().split(' ')[0];\n    var oldPrice = Math.round(+itemPrice * 100 / (100 - 30));\n    jquery__WEBPACK_IMPORTED_MODULE_0___default()(item).parent().find(\".price_item.old\").text(\"\".concat(oldPrice, \" \\u0433\\u0440\\u043D\"));\n  });\n};\n\nvar initOrderModal = function initOrderModal() {\n  jquery__WEBPACK_IMPORTED_MODULE_0___default()(\".product_item .button\").on('click', function (event) {\n    var $button = jquery__WEBPACK_IMPORTED_MODULE_0___default()(event.currentTarget);\n    var $modalOrderProduct = jquery__WEBPACK_IMPORTED_MODULE_0___default()(\".modal-order-form\"); // $modalOrderProduct.html('')\n\n    $modalOrderProduct.find(\".product-img\").html('').append(jquery__WEBPACK_IMPORTED_MODULE_0___default()($button.parent().find(\".slider-item\")[0]).clone());\n    $modalOrderProduct.find(\".product-info\").html('').append($button.parent().find(\".title_block\").clone());\n    $modalOrderProduct.find(\".product-info\").append($button.parent().find(\".price_item.new\").clone());\n    jquery__WEBPACK_IMPORTED_MODULE_0___default.a.fancybox.open({\n      src: '#hidden-content',\n      type: 'inline',\n      opts: {\n        afterShow: function afterShow(instance, current) {// console.info('done!');\n        }\n      }\n    });\n  });\n};\n\nvar sendOrder = function sendOrder(orderData) {\n  jquery__WEBPACK_IMPORTED_MODULE_0___default.a.ajax({\n    method: \"POST\",\n    url: \"./send_order.php\",\n    data: JSON.stringify(orderData),\n    contentType: \"application/json\",\n    beforeSend: function beforeSend() {},\n    success: function success(data) {},\n    error: function error(_error) {\n      console.log('');\n    }\n  });\n};\n\njquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function () {\n  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.catalog_section .slider').slick();\n  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.reviews_section .slider').slick({\n    slidesToShow: 3,\n    slidesToScroll: 1,\n    responsive: [{\n      breakpoint: 959,\n      settings: {\n        slidesToShow: 2\n      }\n    }, {\n      breakpoint: 639,\n      settings: {\n        slidesToShow: 1\n      }\n    }]\n  }); // var elem = document.querySelector('.gallery');\n  // var sizer = document.querySelector('.my-sizer-element');\n  // var shuffleInstance = new Shuffle(elem, {\n  //   itemSelector: '.gallery-item',\n  //   sizer: sizer // could also be a selector: '.my-sizer-element'\n  // });\n\n  countDown();\n  initScrollToLink();\n  calcOldPrice();\n  initOrderModal();\n  var input = jquery__WEBPACK_IMPORTED_MODULE_0___default()(\"input[name='tel']\")[0];\n  var im = new inputmask__WEBPACK_IMPORTED_MODULE_3___default.a(\"+38(099) 999-9999\");\n  im.mask(input);\n  jquery__WEBPACK_IMPORTED_MODULE_0___default()(\"#orderBtn\").on(\"click\", function (event) {\n    var orderData = {};\n\n    if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(\"[name='userName']\").val() !== '') {\n      if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(\"[name='tel']\").val() !== '') {\n        orderData[\"product\"] = jquery__WEBPACK_IMPORTED_MODULE_0___default()(\".modal-order-form .title_block h4\").text();\n        orderData[\"price\"] = jquery__WEBPACK_IMPORTED_MODULE_0___default()(\".modal-order-form .price_item.new\").text();\n        orderData[\"userName\"] = jquery__WEBPACK_IMPORTED_MODULE_0___default()(\"[name='userName']\").val();\n        orderData[\"tel\"] = jquery__WEBPACK_IMPORTED_MODULE_0___default()(\"[name='tel']\").val();\n        sendOrder(orderData);\n      } else {\n        jquery__WEBPACK_IMPORTED_MODULE_0___default.a.fancybox.open('<div class=\"message\"><h2>Заполните номер телефона</h2></p></div>');\n      }\n    } else {\n      jquery__WEBPACK_IMPORTED_MODULE_0___default.a.fancybox.open('<div class=\"message\"><h2>Заполните имя</h2></p></div>');\n    }\n  });\n});\n/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./../../node_modules/webpack/buildin/global.js */ \"./node_modules/webpack/buildin/global.js\")))\n\n//# sourceURL=webpack://my-library/./src/js/main.js?");
